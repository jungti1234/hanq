...
# Run the probe's detector/gate cases against the product implementations too.
for group in detector gate delete; do
    case "$group" in
        ...
        gate) fixture=Tests/OnsetRecoveryProbe/Gate/main.swift; sources=(Sources/HanQ/OnsetInputGate.swift) ;;
        delete) fixture=Tests/OnsetRecoveryProbe/DeleteKey/main.swift; sources=(Sources/HanQ/OnsetDeletionKey.swift) ;;
    esac
